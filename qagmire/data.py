...
# %% auto 0
__all__ = ['via_netcdf', 'ViaNetCDF', 'get_lr_l2_stack_files', 'read_class_table', 'read_star_table', 'not_line_col',
...
def get_lr_l2_stack_files():
    """Get a list of all L2 stack files."""
    l2_stack_glob = os.path.join(os.environ["WEAVEIO_ROOTDIR"], "L2/*/*stack_*APS.fits")
    l2_stack_files = glob(l2_stack_glob)
    l2_stack_files.sort()
    lr_l2_stack_files = [fn for fn in l2_stack_files if _is_lowres(fn)]
    return lr_l2_stack_files
